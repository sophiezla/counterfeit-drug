...
{\bfseries Repository.} All code and derived artifacts are at \url{https://github.com/sophiezla/counterfeit-drug}, archived at {\bfseries doi:10.5281/zenodo.21936720}, which resolves to the current release, {\bfseries v1.1.0} (29 August 2026) --- the exact state of the code that produced every number reported here. It holds the data pipeline, the four model implementations, every analysis and figure script, the per-image statistics and split assignments, the persisted checkpoints, and the sources of this manuscript and its supplement.
