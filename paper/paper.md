...
The remainder is organized as follows. Section II places the mechanism among the terms nearest to it. Sections III and IV give the sources and the four partitions, and Section V the models, the normalization operator of Eq. (8) and the audit stated as a procedure. Section VI reports the audit, the leakage experiment, the two external evaluations and the ablations; Sections VII–X the discussion, limitations, future work and conclusion.
