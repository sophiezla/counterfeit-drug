...
M2 carries an architectural observation that is worth separating from the confound results. It scores 0.865 on the leakage-free split — no statistically significant difference was detected between it and any other model in the roster on the shared internal test partition (Table S5) — and it is the *best* model externally after correction (0.860, Table 5), with the only negative generalization gap anywhere in this study. It reaches that with 23,938 parameters and no pretraining.
...
photograph, of a medicine package, of a current retail product. **It makes no
authenticity judgement**, and could not: nothing visible in a photograph
